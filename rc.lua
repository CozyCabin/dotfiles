...
tags = {
    names = { "www", "chat", "work", "media", "fun", "monitor"},
    layout = { layouts[5], layouts[2], layouts[3], layouts[4], layouts[1], layouts[2]
}}
...
batterywidgettimer:connect_signal("timeout",    
  function()    
    fh = assert(io.popen("acpi | cut -d, -f 2,3 | cut -d':' -f1-2")) --acpi | cut -d, -f 2,3 | cut -d':' -f1-3 | cut -d'r' -f1    
...
for s = 1, screen.count() do
    ...
    right_layout2:add(spacerwidget)
    right_layout2:add(wifi_signal_widget)      
